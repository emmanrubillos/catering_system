    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                ...
                <h5 class="modal-title fw-bold text-white" id="editServiceModalLabel"></i>Edit User</h5>
            ...
            <div class="modal-body">
                ...
                <form id="editUserForm{{ $service->id }}" action="{{ route('service.update', $service->id) }}" method="POST" id="service-update-form" onclick="confirmEditService({{ $service->id }})">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
