    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success text-white">
                ...
                <h5 class="modal-title fw-bold" id="addUserModalLabel">Add Inclusion</h5>
...
<script>
    ...
    $(document).ready(function() {
        $('input[name="classification_id[]"]').on('change', function() {
            var selectedTypes = [];
            $('input[name="classification_id[]"]:checked').each(function() {
                selectedTypes.push($(this).siblings('label').text());
            });

            var listItems = selectedTypes.map(function(type) {
