            ...
            <div class="modal-body">
                <form id="editInclusionForm" action="{{ route('inclusion.update', $inclusion->id) }}" method="POST" id="inclusion-update-form">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="add-inclusion-name" name="name" placeholder="Incluson Name" value="{{ $inclusion->name }}">
                            </div>
                            <div class="form-group">
                                <span class="bg-success pl-3 pr-4 py-2 rounded">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" placeholder="Enter a description ...." name="description" id="add-inclusion-description" rows="5">{{ $inclusion->description }}</textarea>
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success fw-bold" id="save-inclusion-btn">Save</button>
                    </div>
