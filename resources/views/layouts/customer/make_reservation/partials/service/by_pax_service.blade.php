...
<div id="byPaxServiceSelection" class="hidden">
    <div class="relative top-[-9rem]">
        ...
        <div class="flex flex-row gap-20 h-[30rem] mx-20 mt-10">
            ...
            transition-shadow ease-in delay-100 hover:delay-100  hover:shadow-2xl hover:scale-105 hover:shadow:dark">
                ...
                <div id="show-basic-modal"  class="text-center">
            ...
            transition-shadow ease-in delay-150 hover:delay-150  hover:scale-105 hover:shadow-2xl  hover:shadow-dark">
                ...
                <div id="show-standard-modal"  class="text-center">
                    <button class="bg-primary text-light uppercase font-bold text-md px-10 py-2 mt-5
                    transition ease-in-out hover:scale-110 shadow-lg">
                    Select
                    </button>
             ...
             transition-shadow ease-in delay-100 hover:delay-100 hover:shadow-2xl hover:scale-105 hover:shadow-primary-dark ">
                 ...
                 <div class="text-center">
                     <button id="show-premium-modal" class="bg-primary text-light uppercase font-bold text-md px-10 py-2 mt-5
                     transition ease-in-out hover:scale-110 shadow-lg">
                     Select
                     </button>
                 </div>
...
@include('layouts.customer.make_reservation.partials.service._modal.basic-modal')
@include('layouts.customer.make_reservation.partials.service._modal.standard-modal')
@include('layouts.customer.make_reservation.partials.service._modal.premium-modal')
@include('layouts.customer.make_reservation.partials.service.script.open_modal')