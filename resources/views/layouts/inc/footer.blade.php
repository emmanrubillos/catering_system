<footer class="bg-dark w-full h-128 text-light">
    <div class="mx-auto px-10 pt-8 flex flex-row justify-between">
        <div class="column-one basis-1/3">
            <div class="logo">
                <a href="{{ url('/home') }}" class="w-ful">
                    <img src="{{ asset('assets/img/logo/logo-lenght.png') }}" alt="logo-of-titan's">
                </a>
            </div>
            <div class="paragraph text-xsm">
                ...
                <ul>
                    <li class="my-3">
                        <a href="" class="flex">
                            ...
                            <span class="text-sm font-semibold ml-2 mt-1 hover:text-primary">
        ...
        <div class="column-two basis-1/3 flex justify-between">     
                ...
                <ul class="my-2">
                    <li class="my-2">
                        <a href="" class="flex">
                            ...
                            <span class="text-md ml-2 mt-1 hover:text-primary">
                                About Us
                            </span>
                        </a>
                    </li>
            ...
            <div>
                ...
                <h5 class="font-bold uppercase text-lg mt-5">
                    Social Media
                </h5>
        ...
        <div class="column-three basis-1/4">
